...
$sql = "SELECT FL.number AS FLnumber, company, type, time, B.date,B.ID AS id,  departure, d_time, arrival, a_time, C.name AS classname, price, paid
...
$rowcount = mysqli_num_rows($result);
    ...
    while($row = mysqli_fetch_array($result)) {
       ...
       echo "<td><a href='cancelbooking.php?bid=".$row['id']."' >Cancel</a>";
        echo "</tr>";
    }
    echo " </tbody></table>";
