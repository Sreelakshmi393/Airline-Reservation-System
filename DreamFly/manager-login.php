...
// {
	...
	$pwd=$_POST['pwd'];
	$res=mysqli_query($conn,"SELECT * FROM managers WHERE mname='$username'");
	$row=mysqli_fetch_array($res);
	if($row['mpassword']==$pwd)
	{
						...
						<ul class="dropdown-menu multi-level" role="menu" aria-labelledby="dropdownMenu">
						  ...
						  <li class="dropdown-submenu">
							...
							<ul class="dropdown-menu">
							  <li><a tabindex="-1" href="managersignin.html">Manager Sign in</a></li>
	...
	<div class="container" id="homepage">
		<h1>Opps-Seems You Cannot Access This Page</h1>
		<p>Wrong Manager name or wrong password, wait 3s or <a href="managersignin.html">click me back!</a></p>
	</div>
